...
SALARY_100^lambda_trans ~ 
                         AGE_c + PTS_c + REB_c + AST_c + W_c + GP_c,

$$
(SALARY\_100)^{lambda\_trans}\ _{i} = \beta_0 + \beta_1\ PTS{i} + \beta_2\ REB{i} + \beta_3\ AST{i} + \beta_4\ AGE{i} + \beta_5\ WINS{i} + \beta_6\ GAMES{i} + \epsilon_{i};\\ \epsilon_{i}\overset{iid}{\sim} N(0, \sigma^2); \ i = 1,...,n; 
$$                      
                         

$$
SALARY\_100_{i} = \beta_0 + (\beta_1)\ PTS{i} + (\beta_2)\ REB{i} + (\beta_3)\ AST{i} + \epsilon_{i};\ \epsilon_{i}\overset{iid}{\sim} N(0, \sigma^2); \ i = 1,...,n; 
$$
$$
SALARY\_100_{i} = \beta_0 + (\beta_1)\ PTS{i} + (\beta_2)\ REB{i} + (\beta_3)\ AST{i} + \epsilon_{i};\ \epsilon_{i}\overset{iid}{\sim} N(0, \sigma^2); \ i = 1,...,n; 
$$
...
$$
(SALARY\_100)^{lambda\_trans}\ _{i} = (\beta_0 + \gamma_{0\ TEAM} + \gamma_{0\ SEASON}) + \beta_1\ PTS{i} + \beta_2\ REB{i} + \beta_3\ AST{i} + \\ \beta_4\ AGE{i} + \beta_5\ WINS{i} + \beta_6\ GAMES{i} + \epsilon_{i};\ \epsilon_{i}\overset{iid}{\sim} N(0, \sigma^2); \ i = 1,...,n; 
$$    
